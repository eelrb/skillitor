...
To communicate with Slack, It looks like you can define slash commands and then specify a HTTP endpoint that Slack will POST whatever they entered after the command to. We can build an API gateway in Python that relays information between Slack (HTTP) and skillitor-core (gRPC).
...
Must credibly use two HashiCorp tools as part of the application stack.
